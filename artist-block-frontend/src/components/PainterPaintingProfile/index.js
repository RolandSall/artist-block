...
const PainterPaintingProfile = () => {
    ...
    const { data: artist, isLoading} = hooks.usePaintingPainter({
        painterId: id,
        token: token()
    })

    console.log("hqwejqwkeqwkewq" , artist)
...
export default PainterPaintingProfile;
